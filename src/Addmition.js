...
let Addmition = () => {
    ...
    let submitdata = () => {
        ...
        add.map((i) => {
            return  feestotal += parseInt(i.amount);
            console.log(feestotal);
        })

        console.log(val.course);
        if (content.content_id?.total_fees === feestotal) {
            axios.post('http://localhost:5000/course/newadmission', {
                ...
                total_fees: content.content_id?.total_fees || 0,
        ...
        {
            alert("total fees and installment fees are not match ");
        }
    }
...
return (
    ...
    <>
        ...
        <div className="addmi p-5 mx-5">
            <ul className="nav nav-tabs justify-content-center mb-4 border-dark " id="myTab" role="tablist">
                <li className="nav-item tab_border" role="presentation">
                    <button className="nav-link active fw-bold " id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Student Information</button>
                </li>
                <li className="nav-item px-5 tab_border" role="presentation">
                    <button className="nav-link fw-bold" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Course Information</button>
                </li>
                <li className="nav-item tab_border" role="presentation">
                    <button className="nav-link fw-bold" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages" type="button" role="tab" aria-controls="messages" aria-selected="false">Faculty Information</button>
                </li>
            </ul>
                    ...
                    <Row className='my-4'>
                        <Col lg={4} md={6}>
                            <Form.Group as={Col} controlId="formGridEmail">
                                ...
                                <fieldset  >
                                    <Form.Group as={Row} className="mb-3" onChange={studentvalue} name='pc_laptop' value={val.pc_laptop}>
                                        <Col sm={10}>
                                            <Form.Check
                                                type="radio"
                                                label="PC"
